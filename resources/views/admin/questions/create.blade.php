...
<section class="space-y-8">
  <header class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    <div>
      <h1 class="text-2xl font-semibold tracking-tight">New Question</h1>
      <p class="text-sm text-muted-foreground">Author a question for <span class="font-semibold text-foreground">{{ $module->title }}</span>.</p>
    </div>
  ...
  <div class="card-surface">
    <form method="POST" action="{{ route('admin.modules.questions.store', $module) }}" class="grid gap-6">
